...
const ProductController = {
  createProduct: async (req, res) => {
    // Validate the product data in the request body
  ...
  getProductByProductCode: async (req, res) => {
    // Validate the product_code parameter
...
//   getProductByProductCode: async (req, res) => {
//     try {
//       const product = await ProductService.getProductByProductCode(req.params.product_code);
//       if (!product) return res.status(404).json({ error: 'Product not found' });
//       res.status(200).json(product);
//     } catch (err) {
//       res.status(500).json({ error: 'Failed to retrieve product' });
...
//   getProductBySupplierId: async (req, res) => {
//     try {
//       const product = await ProductService.getProductBySupplierId(req.params.supplier_id);
//       if (!product) return res.status(404).json({ error: 'Product not found' });
//       res.status(200).json(product);
//     } catch (err) {
//       res.status(500).json({ error: 'Failed to retrieve product' });
...
//   deleteProduct: async (req, res) => {
//     try {
//       await ProductService.deleteProduct(req.params.product_code);
//       res.status(204).send();
//     } catch (err) {
//       res.status(500).json({ error: 'Failed to delete product' });
//     }
